...
public class MapUtil {
    ...
    public static void main(String args[]) {
        ...
        test.put("123", new Date());

        System.out.println(MapUtil.getString(test.get("123")));
        System.out.println(MapUtil.getDouble(test.get("123")));
        System.out.println(MapUtil.getInteger(test.get("123")));
        System.out.println(MapUtil.getLong(test.get("123")));
    }
}
