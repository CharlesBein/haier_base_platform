package cn.gooday.logistics.web.util.poi;
...
//	 */
//	private static Map<Class<?>, Integer[]> validateMap = new ConcurrentHashMap<Class<?>, Integer[]>();
//
//	static {
//		validateMap
...
//			cell.setCellStyle(titleStyle(sheet.getWorkbook()));
...
//						HSSFCell cell = row.createCell(cellNum);
//						cell.setCellStyle(contentStyle(index, sheet.getWorkbook()));
...
//	 * 美化内容行
//	 */
//	private static  HSSFCellStyle contentStyle(int i,HSSFWorkbook wb) {
//
//		HSSFCellStyle style = wb.createCellStyle();
//
//		// 居中
