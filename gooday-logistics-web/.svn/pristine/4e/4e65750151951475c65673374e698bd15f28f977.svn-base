...
package cn.gooday.logistics.web.logic.demo.vo;


/**
 * @ClassName: HmModelDatasetMpping
 * @Description: HmModelDatasetMpping VO对象
 * @author:赵士杰
 *
 */

public  final  class HmModelDatasetMppingIntVo implements java.io.Serializable {
	
	private static final long serialVersionUID = -6502185862709577375L;
